...
namespace ckLib
{
	public class IdeaHelper
	{
		...
		/// </summary>
		static public string CreateUrl(int id)
		{
			...
			{
				ErrorHandler.Handle(new ckExceptionData(ex, "IdeaHeler:CreateUrl", id.ToString()));
			}
